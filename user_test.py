...
class TestUser( unittest.TestCase):
    ...
    def setUp(self):
        self.new_user = User("Brenda", "Muthoni","bmuthoni39@gmail.com","@bm2015!")
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_user.email, "bmuthoni39@yaho.com")
        self.assertEqual(self.new_user.password, "@bm2015!")
    ...
    def test_user_password(self):
        self.new_user.save_user()
        password_entered = User.password_correct("@bm2015!")
    ...
    def test_user_exist(self):
        self.new_user.save_user()
        name_entered = User.name_exists("Brenda", "Muthoni")
